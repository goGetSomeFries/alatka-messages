...
public class DatabaseMessageDefinitionBuilderTest {
    ...
    void test01() throws SQLException {
        ...
        doReturn(null, "com.alatka.messages.holder.MessageHolder").when(resultSet).getString("M_HOLDER");
        ...
        Assertions.assertEquals("com.alatka.messages.holder.MessageHolder", sources.get(0).get("holder"));
    ...
    void test03() {
        ...
        doReturn(null, "com.alatka.messages.holder.MessageHolder").when(source).get("holder");

...
public class F61 {
    ...
    private Integer f61f6;
    @IsoFieldMeta(domainNo = 7, fixed = true, length = 3, remark = "无卡校验结果")
    ...
    @IsoFieldMeta(domainNo = 10, fixed = false, length = -1, maxLength = 165, remark = "安全信息校验值-安全认证信息", existSubdomain = true, subdomainType = MessageDefinition.DomainType.UV)
    private UsageSubdomain<F61F10> f61f10;
    ...
    public Integer getF61f6() {
        return f61f6;
    }

    public void setF61f6(Integer f61f6) {
        this.f61f6 = f61f6;
    }
    ...
    public UsageSubdomain<F61F10> getF61f10() {
        return f61f10;
    }

    public void setF61f10(UsageSubdomain<F61F10> f61f10) {
        this.f61f10 = f61f10;
    }
}

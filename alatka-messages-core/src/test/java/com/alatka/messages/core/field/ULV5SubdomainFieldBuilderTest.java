...
public class ULV5SubdomainFieldBuilderTest {

    private ULV5SubdomainFieldBuilder fieldBuilder = new ULV5SubdomainFieldBuilder();
    ...
    void test02() {
        ...
        fieldDefinition.setSubdomainType(MessageDefinition.DomainType.ULV5);
